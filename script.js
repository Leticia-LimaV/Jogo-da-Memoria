const dadosDasCartas = [
    {img: "catNoir.jpg", id: 1},
    {img: 'LadyBug.jpg', id: 2},
    {img: 'Natal.jpg', id:3},
    {img: "catNoir.jpg", id: 1},
    {img: 'LadyBug.jpg', id: 2},
    {img: 'Natal.jpg', id:3}
...
let cartasViradas = []
let tentativas = 0
let paresEncontradods = 0
let estaVirando = false

const elementosDeCarta = document.querySelectorAll('.carta');
const elementoMensagens = document.getElementById('mensagem');
...
function inicializarJogo() {
    ...
    elementoMensagens.textContent = 'Encontre todos os pares!';
...
function verificarPar() {
    ...
    if (dadosDasCartas[primeiroIndice].id === dadosDasCartas[segundoIndice].id) {
        ...
        if (paresEncontrados === dadosDasCartas.length / 2) {
            elementoMensagens.textContent = 'PARABÉNS! Você encontrou todos os pares!';
        }
    } else {
